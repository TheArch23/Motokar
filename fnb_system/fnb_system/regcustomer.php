  ...
  <div class="form-container">
    ...
    <?php
      ...
      if(isset($_POST["submit"])) {
        ...
        // Generate a user ID
        $user_id = 'CU'.strval(rand(10000, 99999));

        // Insert the user data into the database
        $sql = "INSERT INTO customer (cust_id, cust_name, cust_username, cust_password, cust_email, cust_phonenum) VALUES ('$user_id', '$name', '$username', '$password', '$email', '$phone')";
